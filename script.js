...
//START BUTTON
document.getElementById('start').addEventListener('click', () => {isRunning = !isRunning; disableStart(); gameLoop()});
  ...
  update() {
    ...
    if (this.moving) {
      ...
      switch(this.pointerPosIndex){
        case 1: this.pointerXEnd = ball.x + ball.radius - 28;
                this.pointerYEnd = ball.y -28;
                this.dx = -10;
                this.dy = -10;
                this.xDirection = "left";
          break;
        case 2: this.pointerXEnd = ball.x + ball.radius;
                this.pointerYEnd = ball.y -28;
                this.dx = 0;
                this.dy = -10;
                this.xDirection = 'straight';
          break;
        case 3: this.pointerXEnd = ball.x + ball.radius + 28;
                this.pointerYEnd = ball.y - 28;
                this.dx = 10;
                this.dy = -10;
                this.xDirection = 'right';
          break;
        default: this.pointerXEnd = ball.x + ball.radius;
          this.pointerYEnd = ball.y -28;
          this.dx = 0;
          this.dy = -10;
          this.xDirection = 'straight';
...
function checkBrickCollision() {
  ...
  if (ball.x + ball.radius >= player.x && ball.x + ball.radius <= player.x + player.width && ball.y + ball.height === player.y + 9) {
...
function checkBossCollision(){
  if (ball.x + ball.radius >= boss1.x & ball.x + ball.radius <= boss1.x + boss1.width) {
...
} else if (ball.y + ball.radius >= 0 & ball.y + ball.radius <= boss1.height) {
